...
Send files to be analyzed by Cuckoo.
...
- Clone from the GitHub [logstash-filter-cuckoo](https://github.com/redBorder/logstash-filter-cuckoo)
...
```sh
gem build logstash-filter-cuckoo.gemspec
```
